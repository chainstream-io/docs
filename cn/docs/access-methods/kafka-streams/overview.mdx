...
<CardGroup cols={3}>
  <Card title="EVM Streams" icon="ethereum" href="/cn/docs/access-methods/kafka-streams/evm-streams">
    Ethereum、BSC、Base、Polygon、Optimism
  </Card>
  <Card title="Solana Streams" icon="circle-s" href="/cn/docs/access-methods/kafka-streams/solana-streams">
    Solana 高吞吐数据流
  </Card>
  <Card title="TRON Streams" icon="circle-t" href="/cn/docs/access-methods/kafka-streams/tron-streams">
    TRON 网络数据流
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="实时数据流" icon="bolt" href="/cn/docs/access-methods/websocket">
    WebSocket 实时数据接入指南
  </Card>
  <Card title="认证指南" icon="key" href="/cn/docs/platform/authentication/api-keys-oauth">
    获取 Access Token
  </Card>
</CardGroup>
