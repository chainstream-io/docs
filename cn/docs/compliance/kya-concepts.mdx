...
<CardGroup cols={2}>
  <Card title="合规集成指南" icon="plug" href="/cn/docs/compliance/integration-guide">
    开始接入 KYA
  </Card>
  <Card title="KYT 核心概念" icon="magnifying-glass-dollar" href="/cn/docs/compliance/kyt-concepts">
    了解交易维度风控
  </Card>
  <Card title="API 认证" icon="key" href="/cn/docs/platform/authentication/api-keys-oauth">
    了解认证方式
  </Card>
  <Card title="KYA API 参考" icon="code" href="/cn/api-reference/endpoint/data/kyt/v2/kyt-address-post">
    查看接口文档
  </Card>
</CardGroup>
