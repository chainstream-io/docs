...
<CardGroup cols={2}>
  <Card title="认证" icon="key" href="/cn/docs/platform/authentication/api-keys-oauth">
    认证与凭据管理
  </Card>
  <Card title="数据隐私" icon="shield" href="/cn/docs/platform/security/data-privacy">
    数据隐私政策
  </Card>
  <Card title="错误码" icon="circle-exclamation" href="/cn/docs/reference/error-codes">
    完整错误码列表
  </Card>
  <Card title="Webhook 基础" icon="webhook" href="/cn/docs/recipes/webhook-fundamentals">
    Webhook 配置与使用
  </Card>
</CardGroup>
