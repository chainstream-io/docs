...
在开始之前，建议先阅读 [Smart Money 方法论](/cn/docs/data-products/smart-money)，了解：
...
<Info>
本教程中的 WebSocket 示例使用简化的伪代码来说明概念。实际的 WebSocket 订阅格式和可用频道，请参阅 [WebSocket API 参考文档](/cn/api-reference/endpoint/websocket/api)。
</Info>
