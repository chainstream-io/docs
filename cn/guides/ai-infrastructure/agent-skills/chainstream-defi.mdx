...
description: '不可逆 DeFi 执行 — 兑换、跨链桥、Launchpad、交易广播'
icon: "right-left"
---
...
`chainstream-defi` skill 处理 Solana、BSC 和 Ethereum 上的链上 DeFi 执行，涵盖代币兑换、跨链桥、Launchpad 发币和交易广播。
...
| 402 需要付款 | CLI 通过 [x402 支付](/cn/guides/cli/x402-payment) 自动处理 |
