...
<CardGroup cols={2}>
  <Card title="MCP Server" icon="robot" color="#9333EA" href="/cn/guides/ai-infrastructure/mcp-server/introduction">
    Model Context Protocol 服务，让 AI 模型直接调用 ChainStream API
  </Card>
  <Card title="Agent Skills" icon="brain" color="#4D9CFF" href="/cn/guides/ai-infrastructure/agent-skills/introduction">
    结构化 AI 能力包（SKILL.md），支持 Cursor、Claude Code、Codex 等
  </Card>
  <Card title="CLI" icon="terminal" color="#10B981" href="/cn/guides/cli/overview">
    命令行工具，内置钱包和 x402 支付，用于数据查询和 DeFi 执行
  </Card>
  <Card title="x402 支付" icon="credit-card" color="#F59E0B" href="/cn/guides/cli/x402-payment">
    HTTP 原生微支付 — AI Agent 使用 USDC 付费，无需注册账户
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Skills" icon="brain" href="/cn/guides/ai-infrastructure/agent-skills/introduction">
    在 Cursor、Claude Code 等平台安装 Skills
  </Card>
  <Card title="CLI 概览" icon="terminal" href="/cn/guides/cli/overview">
    通过命令行查询数据和执行 DeFi
  </Card>
