...
完整兼容性表格和配置文件位置请参阅[跨 Agent 兼容性](/cn/guides/integrations/openclaw/cross-agent-compatibility)。
...
<Note>
  ClawHub Skill 提供 17 个 MCP 工具（15 个核心工具加 2 个 ClawHub 专用工具）。核心工具集详情请参阅[工具参考](/cn/guides/ai-infrastructure/mcp-server/overview)。
</Note>
...
详见 [MCP Server 设置](/cn/guides/ai-infrastructure/mcp-server/setup-guide) 了解 Claude Desktop、Cursor 等客户端的详细配置。
...
<CardGroup cols={2}>
  <Card title="跨 Agent 兼容性" icon="arrows-rotate" href="/cn/guides/integrations/openclaw/cross-agent-compatibility">
