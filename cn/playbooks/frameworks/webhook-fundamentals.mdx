...
| 功能 | 端点 |
|------|------|
| 获取端点列表 | `GET /v2/webhook/endpoint` |
| 创建端点 | `POST /v2/webhook/endpoint` |
| 更新端点 | `PATCH /v2/webhook/endpoint` |
| 获取端点详情 | `GET /v2/webhook/endpoint/{id}` |
| 删除端点 | `DELETE /v2/webhook/endpoint/{id}` |
| 获取密钥 | `GET /v2/webhook/endpoint/{id}/secret` |
| 轮换密钥 | `POST /v2/webhook/endpoint/{id}/secret/rotate` |
...
<CardGroup cols={2}>
  ...
  <Card title="Endpoint API 参考" icon="code" href="/cn/api-reference/endpoint/data/endpoint/v2/webhook-endpoint-post">
    完整 API 文档
  </Card>
</CardGroup>
