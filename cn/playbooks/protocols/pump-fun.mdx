...
完整工具说明见 [MCP 工具目录](/cn/guides/ai-infrastructure/mcp-server/tools-catalog)。
  </Tab>
</Tabs>
...
<AccordionGroup>
  ...
  <Accordion title="能否实时跟踪 Pump.fun 代币？">
    可以。使用 WebSocket 订阅获取实时价格与成交流。配置方式见 [实时流式传输](/cn/guides/data-concepts/realtime-streaming)。
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="代币分析框架" icon="magnifying-glass-chart" href="/cn/playbooks/frameworks/token-analysis-framework">
    系统化的代币评估方法。
  </Card>
  <Card title="MCP 工具目录" icon="robot" href="/cn/guides/ai-infrastructure/mcp-server/tools-catalog">
    50+ MCP 工具完整列表，便于接入 AI Agent。
  </Card>
  <Card title="Raydium 指南" icon="droplet" href="/cn/playbooks/protocols/raydium">
