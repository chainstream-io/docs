...
| 端点 | 描述 |
|------|------|
| `POST /v2/kyt/transfer` | 注册交易进行 KYT 分析 |
| `GET /v2/kyt/transfers/{id}/summary` | 获取交易摘要 |
| `GET /v2/kyt/transfers/{id}/alerts` | 获取交易警报 |
| `GET /v2/kyt/transfers/{id}/exposures/direct` | 获取直接风险敞口信息 |
