...
<CardGroup cols={2}>
  <Card title="REST — Data" icon="database" href="/en/api-reference/endpoint/data/tokens/search">
  ...
  <Card title="REST — DeFi" icon="right-left" href="/en/api-reference/endpoint/defi/quote">
    DEX aggregator endpoints: quote, route, simulate, swap, transaction status.
  </Card>
