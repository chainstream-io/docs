...
description: 'Version update records for ChainStream JavaScript SDK'
icon: "notebook"
---

This document records all important updates, new features, and bug fixes for ChainStream JavaScript SDK.
...
- Added `client.endpoint.list()` - Get list of webhook endpoints
- Added `client.endpoint.create()` - Create a new webhook endpoint
- Added `client.endpoint.get()` - Get webhook endpoint details
- Added `client.endpoint.update()` - Update webhook endpoint configuration
- Added `client.endpoint.delete()` - Delete a webhook endpoint
- Added `client.endpoint.getSecret()` - Get webhook endpoint secret
- Added `client.endpoint.rotateSecret()` - Rotate webhook endpoint secret
