...
<CardGroup cols={3}>
  ...
  <Card title="Solana Streams" icon="circle-s" href="/en/docs/access-methods/kafka-streams/solana-streams">
    Solana high-throughput data streams
  </Card>
  <Card title="TRON Streams" icon="circle-t" href="/en/docs/access-methods/kafka-streams/tron-streams">
...
<CardGroup cols={2}>
  ...
  <Card title="Authentication Guide" icon="key" href="/en/docs/platform/authentication/api-keys-oauth">
    Get Access Token
  </Card>
</CardGroup>
