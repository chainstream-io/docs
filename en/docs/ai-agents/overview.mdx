...
<CardGroup cols={2}>
  ...
  <Card title="Agent Skills" icon="brain" href="/en/docs/ai-agents/agent-skills/introduction">
    ...
    ChainStream — patterns for token analysis, Smart-Money tracking, DeFi
    execution, and more. Ships ready for Cursor, Claude Code and Codex.
  </Card>
</CardGroup>
...
| You want to install a ready-made agent skill for token research | [Agent Skills](/en/docs/ai-agents/agent-skills/chainstream-data) |
