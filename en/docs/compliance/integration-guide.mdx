...
<CardGroup cols={2}>
  <Card title="Authentication Docs" icon="key" href="/en/docs/platform/authentication/api-keys-oauth">
    Detailed authentication guide
  </Card>
  <Card title="KYT Concepts" icon="shield" href="/en/docs/compliance/kyt-concepts">
    KYT core concepts
  </Card>
