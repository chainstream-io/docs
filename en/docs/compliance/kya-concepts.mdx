...
<CardGroup cols={2}>
  <Card title="Compliance Integration Guide" icon="plug" href="/en/docs/compliance/integration-guide">
    Start integrating KYA
  </Card>
  <Card title="KYT Core Concepts" icon="magnifying-glass-dollar" href="/en/docs/compliance/kyt-concepts">
    Learn about transaction-level risk control
  </Card>
  <Card title="API Authentication" icon="key" href="/en/docs/platform/authentication/api-keys-oauth">
    Understand authentication methods
  </Card>
  <Card title="KYA API Reference" icon="code" href="/en/api-reference/endpoint/data/kyt/v2/kyt-address-post">
