...
<CardGroup cols={2}>
  <Card title="Smart-money tracker tutorial" icon="user-secret" href="/en/docs/tutorials/smart-money-tracker">
    Hands-on: build a Smart Money tracking system end-to-end.
  </Card>
  <Card title="Real-time streaming" icon="bolt" href="/en/docs/access-methods/websocket">
    WebSocket and Kafka channels for live Smart Money flow.
  </Card>
  <Card title="Wallets" icon="wallet" href="/en/docs/data-products/wallets">
    The underlying product Smart Money is built on.
  </Card>
  <Card title="Trades" icon="right-left" href="/en/docs/data-products/trades">
    The trade stream filtered to Smart Money cohorts.
  </Card>
</CardGroup>
