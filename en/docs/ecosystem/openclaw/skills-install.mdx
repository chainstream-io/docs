...
See [Cross-Agent Compatibility](/en/guides/integrations/openclaw/cross-agent-compatibility) for the full compatibility table and config file locations.
...
<Note>
  The ClawHub skill exposes 17 MCP tools (the 15 core tools plus 2 ClawHub-specific utilities). See the [Tools Reference](/en/guides/ai-infrastructure/mcp-server/overview) for details on the core toolset.
</Note>
...
See [MCP Server Setup](/en/guides/ai-infrastructure/mcp-server/setup-guide) for detailed configuration with Claude Desktop, Cursor, and other clients.
...
<CardGroup cols={2}>
  <Card title="Cross-Agent Compatibility" icon="arrows-rotate" href="/en/guides/integrations/openclaw/cross-agent-compatibility">
