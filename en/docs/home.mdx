...
<CardGroup cols={4}>
  <Card title="Supported Chains" icon="link">
    **3 Chains**
    ...
    Solana, Ethereum, BSC — full data + DeFi coverage
  </Card>
...
<CardGroup cols={2}>
  <Card title="AI Developers" icon="robot" href="/en/guides/ai-infrastructure/mcp-server/introduction">
    **Use cases**: AI Agent, automated trading, MCP integration
    ...
    Connect your AI Agent to on-chain data via MCP Server or Agent Skills.
  </Card>
  <Card title="Data Users" icon="database" href="/en/guides/data-concepts/realtime-streaming">
    **Use cases**: dApp development, market display, data analysis
    ...
    Access real-time prices, trades, and wallet data via SDK or API.
  </Card>
  <Card title="DeFi Builders" icon="right-left" href="/en/guides/cli/overview">
    **Use cases**: Token swaps, token creation, DeFi automation
    
    Execute DeFi operations via CLI or SDK with built-in wallet signing.
  </Card>
  <Card title="Compliance Users" icon="shield" href="/en/guides/security-compliance/overview">
    **Use cases**: Exchange risk control, wallet security, compliance auditing
    ...
    Built-in KYT/KYA for transaction and address risk assessment.
  </Card>
</CardGroup>
