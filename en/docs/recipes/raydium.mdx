...
<AccordionGroup>
  ...
  <Accordion title="Can I track Raydium pool events in real time?">
    Yes. Use WebSocket subscriptions for real-time pool and trade updates. See [Real-time Streaming](/en/guides/data-concepts/realtime-streaming) for setup instructions.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Pump.fun Guide" icon="rocket" href="/en/playbooks/protocols/pump-fun">
