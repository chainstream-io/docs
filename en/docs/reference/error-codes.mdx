...
| Credit limit exceeded | Query may be rejected depending on billing plan — check `extensions.credits` |

See [GraphQL Billing & Credits](/en/graphql/billing/graphql-billing) for the full credit calculation formula.
...
See [WebSocket API Reference](/en/api-reference/endpoint/websocket/api) and [Timeouts & Heartbeats](/en/api-reference/endpoint/websocket/timeouts-and-heartbeats) for connection management details.
