...
Before starting, we recommend reading [Smart Money Methodology](/en/docs/data-products/smart-money) to understand:
...
<Info>
The WebSocket examples in this tutorial use simplified pseudo-code to illustrate the concept. For the actual WebSocket subscription format and available channels, see the [WebSocket API Reference](/en/api-reference/endpoint/websocket/api).
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Webhook Fundamentals" icon="webhook" href="/en/docs/recipes/webhook-fundamentals">
