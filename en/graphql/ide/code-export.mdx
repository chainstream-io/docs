---
title: "Code Export"
description: "Generate ready-to-use code snippets from your GraphQL queries in 8 programming languages"
icon: "file-export"
---
...
| **WebSocket** | `graphql-ws` protocol | Real-time subscriptions, streaming |
...
- **WebSocket for streaming** — The WebSocket export uses the `graphql-ws` protocol, suitable for subscriptions and long-lived connections.
