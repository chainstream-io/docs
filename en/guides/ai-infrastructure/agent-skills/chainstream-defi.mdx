...
description: 'Irreversible DeFi execution — swap, bridge, launchpad, transaction broadcast'
icon: "right-left"
---
...
| 402 Payment required | CLI auto-handles via [x402 payment](/en/guides/cli/x402-payment) |
