...
The schema is available [here](https://github.com/chainstream-io/streaming_protobuf).

The complete code is available [here](https://github.com/chainstream-io/stream_protobuf_example).
