...
<Tabs>
  <Tab title="Token API">
    | API | Units | Endpoint |
    |:--|:--|:--|
    | Token Price | 1 | `GET /v2/token/{chain}/{tokenAddress}/price` |
    | Batch Price | 1 | `GET /v2/token/{chain}/{tokenAddress}/prices` |
    | Token Metadata | 1 | `GET /v2/token/{chain}/metadata/multi` |
    | Token Market Data | 1 | `GET /v2/token/{chain}/{tokenAddress}/marketdata` |
    | Batch Market Data | 1 | `GET /v2/token/{chain}/marketdata/multi` |
    | Token Stats | 1 | `GET /v2/token/{chain}/{tokenAddress}/stats` |
    | Batch Stats | 1 | `GET /v2/token/{chain}/stats/multi` |
    | Token Candles | 1 | `GET /v2/token/{chain}/{tokenAddress}/candles` |
    | Token Holders | 2 | `GET /v2/token/{chain}/{tokenAddress}/holders` |
    | Batch Holders | 2 | `GET /v2/token/{chain}/{tokenAddress}/holders/multi` |
    | Top Holders | 2 | `GET /v2/token/{chain}/{tokenAddress}/topholders` |
    | Liquidity Snapshots | 2 | `GET /v2/token/{chain}/{tokenAddress}/liquiditysnapshots` |
    | Security Check | 2 | `GET /v2/token/{chain}/{tokenAddress}/security` |
    | Creation Info | 1 | `GET /v2/token/{chain}/{tokenAddress}/creation` |
    | Mint/Burn | 2 | `GET /v2/token/{chain}/{tokenAddress}/mintandburn` |
    | Traders by Tag | 2 | `GET /v2/token/{chain}/{tokenAddress}/traders/{tag}` |
    | Token List | 1 | `GET /v2/token/{chain}/list` |
    | Dev Tokens | 2 | `GET /v2/token/{chain}/dev/{devAddress}/tokens` |
    | Token Pools | 1 | `GET /v2/token/{chain}/{tokenAddress}/pools` |
  </Tab>
  <Tab title="Wallet API">
    | API | Units | Endpoint |
    |:--|:--|:--|
    | Wallet Balance | 2 | `GET /v2/wallet/{chain}/{walletAddress}/balance` |
    | Balance Updates | 2 | `GET /v2/wallet/{chain}/{walletAddress}/balance/updates` |
    | Wallet Info | 1 | `GET /v2/wallet/{chain}/{walletAddress}` |
    | Wallet Stats | 2 | `GET /v2/wallet/{chain}/{walletAddress}/stats` |
    | PnL Calculation | 3 | `POST /v2/wallet/{chain}/{walletAddress}/calculate-pnl` |
    | Add to Watchlist | 1 | `POST /v2/watchlist/{chain}/{walletAddress}` |
  </Tab>
  <Tab title="Trade API">
    | API | Units | Endpoint |
    |:--|:--|:--|
    | Token Trades | 2 | `GET /v2/trade/{chain}` |
    | Trade Activities | 2 | `GET /v2/trade/{chain}/activities` |
    | Top Traders | 2 | `GET /v2/trade/{chain}/top-traders` |
  </Tab>
  <Tab title="Pool API">
    | API | Units | Endpoint |
    |:--|:--|:--|
    | Pool Info | 1 | `GET /v2/dexpools/{chain}/{poolAddress}` |
    | Pool Snapshots | 2 | `GET /v2/dexpools/{chain}/{poolAddress}/snapshots` |
  </Tab>
  <Tab title="Ranking API">
    | API | Units | Endpoint |
    |:--|:--|:--|
    | Hot Tokens | 1 | `GET /v2/ranking/{chain}/hottokens/{duration}` |
    | New Tokens | 1 | `GET /v2/ranking/{chain}/newtokens` |
    | Graduated Tokens | 1 | `GET /v2/ranking/{chain}/migrated` |
    | Final Stretch | 1 | `GET /v2/ranking/{chain}/finalstretch` |
    | Stock Tokens | 1 | `GET /v2/ranking/{chain}/stocks` |
  </Tab>
  <Tab title="DEX API">
    | API | Units | Endpoint |
    |:--|:--|:--|
    | Supported DEXs | 1 | `GET /v2/dex` |
    | Quote | 2 | `GET /v2/dex/{chain}/quote` |
    | Route | 2 | `POST /v2/dex/{chain}/route` |
    | Create Tx | 3 | `POST /v2/dex/{chain}/create` |
    | Execute Swap | 5 | `POST /v2/dex/{chain}/swap` |
  </Tab>
  <Tab title="Blockchain API">
    | API | Units | Endpoint |
    |:--|:--|:--|
    | Supported Chains | 1 | `GET /v2/blockchain` |
    | Latest Block | 1 | `GET /v2/blockchain/{chain}/latest_block` |
    | Gas Price | 1 | `GET /v2/transaction/{chain}/gas-price` |
    | Gas Estimate | 2 | `POST /v2/transaction/{chain}/estimate-gas-limit` |
    | Send Transaction | 3 | `POST /v2/transaction/{chain}/send` |
  </Tab>
</Tabs>
...
| API | Units | Endpoint |
|:--|:--|:--|
| List Webhooks | 1 | `GET /v2/webhook/endpoint` |
| Create Webhook | 2 | `POST /v2/webhook/endpoint` |
| Get Webhook | 1 | `GET /v2/webhook/endpoint/{id}` |
| Update Webhook | 2 | `PATCH /v2/webhook/endpoint` |
| Delete Webhook | 1 | `DELETE /v2/webhook/endpoint/{id}` |
| Get Secret | 1 | `GET /v2/webhook/endpoint/{id}/secret` |
| Rotate Secret | 2 | `POST /v2/webhook/endpoint/{id}/secret/rotate` |
...
| API | Cost | Endpoint |
|:--|:--|:--|
| Deposit Risk Assessment | $0.25/call | `POST /v2/kyt/transfer` |
| Withdrawal Risk Assessment | $0.25/call | `POST /v2/kyt/withdrawal` |
