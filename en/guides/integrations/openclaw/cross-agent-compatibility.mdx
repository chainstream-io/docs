...
See also: [Stdio Transport](/en/guides/ai-infrastructure/mcp-server/stdio-transport) for manual Claude Code setup.
...
<CardGroup cols={2}>
  <Card title="Tools Reference" icon="wrench" href="/en/guides/ai-infrastructure/mcp-server/overview">
