...
We use the following labels to categorize changes:

- **New Feature** — New functionality or capability
- **Improvement** — Enhancement to existing features
- **Bug Fix** — Resolved issues or defects
- **Breaking Change** — Changes that require action from users
...
**Bug Fix**
- TypeScript SDK: Fixed subscription reconnection issues
- Python SDK v0.1.3: Async client performance optimization
- Go SDK v0.1.3: Error handling and memory usage improvements

**New Feature**
- Rust SDK v0.1.3: First stable release with complete API coverage
- Python SDK v0.1.3: Enhanced type hints
...
<CardGroup cols={3}>
  <Card title="RSS Feed" icon="rss" href="https://docs.chainstream.io/rss.xml">
    Subscribe via RSS for automatic updates
  </Card>
