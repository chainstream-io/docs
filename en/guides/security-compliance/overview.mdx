...
<Tabs>
  <Tab title="Transaction Risk (KYT)">
    ...
    **Step 2: Query Results**
    ...
    ```bash
    # Get risk summary
    GET /v2/kyt/transfers/{transferId}/summary
    
    # Get risk alerts
    GET /v2/kyt/transfers/{transferId}/alerts
    
    # Get direct risk exposure
    GET /v2/kyt/transfers/{transferId}/exposures/direct
    ```
  </Tab>
  ...
  <Tab title="Address Risk (KYA)">
    ...
    **Step 2: Query Risk Rating**
    ...
    ```bash
    GET /v2/kyt/addresses/{address}/risk
    ```
  </Tab>
