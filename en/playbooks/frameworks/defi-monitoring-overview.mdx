...
| Function | Endpoint |
|----------|----------|
| Get Protocol TVL | `GET /v2/defi/{protocol}/tvl` |
| Get Pool Info | `GET /v2/defi/{protocol}/pools/{pool_id}` |
| Get User Positions | `GET /v2/defi/{protocol}/positions/{address}` |
| Get Yield Data | `GET /v2/defi/{protocol}/yields` |
