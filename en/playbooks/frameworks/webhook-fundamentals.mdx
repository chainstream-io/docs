...
```bash
GET /v2/webhook/endpoint/{id}/secret
```
...
```bash
GET /v2/webhook/endpoint/{id}
```

### Update Endpoint

```bash
PATCH /v2/webhook/endpoint
```
...
```bash
DELETE /v2/webhook/endpoint/{id}
```

### Rotate Secret

```bash
POST /v2/webhook/endpoint/{id}/secret/rotate
```
...
| Function | Endpoint |
|----------|----------|
| List Endpoints | `GET /v2/webhook/endpoint` |
| Create Endpoint | `POST /v2/webhook/endpoint` |
| Update Endpoint | `PATCH /v2/webhook/endpoint` |
| Get Endpoint Details | `GET /v2/webhook/endpoint/{id}` |
| Delete Endpoint | `DELETE /v2/webhook/endpoint/{id}` |
| Get Secret | `GET /v2/webhook/endpoint/{id}/secret` |
| Rotate Secret | `POST /v2/webhook/endpoint/{id}/secret/rotate` |
...
<CardGroup cols={2}>
  ...
  <Card title="Endpoint API Reference" icon="code" href="/en/api-reference/endpoint/data/endpoint/v2/webhook-endpoint-post">
