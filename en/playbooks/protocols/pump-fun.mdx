...
See [MCP Tools Catalog](/en/guides/ai-infrastructure/mcp-server/tools-catalog) for full tool reference.
  </Tab>
</Tabs>
...
<AccordionGroup>
  ...
  <Accordion title="Can I track Pump.fun tokens in real time?">
    Yes. Use WebSocket subscriptions for real-time price updates and trade streams. See [Real-time Streaming](/en/guides/data-concepts/realtime-streaming) for setup instructions.
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Token Analysis Framework" icon="magnifying-glass-chart" href="/en/playbooks/frameworks/token-analysis-framework">
    Comprehensive token evaluation methodology.
  </Card>
  <Card title="MCP Tools Catalog" icon="robot" href="/en/guides/ai-infrastructure/mcp-server/tools-catalog">
    Full list of 50+ MCP tools for AI agent integration.
  </Card>
  <Card title="Raydium Guide" icon="droplet" href="/en/playbooks/protocols/raydium">
