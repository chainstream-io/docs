...
|----------|-------------|
| `POST /v2/kyt/transfer` | Register a transfer for KYT analysis |
| `GET /v2/kyt/transfers/{id}/summary` | Get transfer summary |
| `GET /v2/kyt/transfers/{id}/alerts` | Get transfer alerts |
| `GET /v2/kyt/transfers/{id}/exposures/direct` | Get direct exposure info |
