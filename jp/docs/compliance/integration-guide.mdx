...
<CardGroup cols={2}>
  <Card title="認証ドキュメント" icon="key" href="/jp/guides/getting-started/authentication">
    認証の詳細ガイド
  </Card>
  <Card title="KYT の概念" icon="shield" href="/jp/guides/data-concepts/kyt-concepts">
    KYT の中核概念
  </Card>
  <Card title="KYA の概念" icon="user-shield" href="/jp/guides/data-concepts/kya-concepts">
    KYA の中核概念
  </Card>
  <Card title="KYT API リファレンス" icon="code" href="/jp/api-reference/endpoint/kyt/v1/kyt-transfer-post">
    KYT API の完全ドキュメント
  </Card>
</CardGroup>
