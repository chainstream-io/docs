...
<CardGroup cols={2}>
  <Card title="x402 支払いプロトコル" icon="money-bill-wave" href="/jp/docs/platform/billing-payments/x402-payments">
    x402 プロトコルによるオンチェーン USDC 支払い
  </Card>
  <Card title="課金とユニット" icon="receipt" href="/jp/docs/platform/billing-payments/plans-and-units">
    CU 消費量とプランの詳細を理解する
  </Card>
</CardGroup>
