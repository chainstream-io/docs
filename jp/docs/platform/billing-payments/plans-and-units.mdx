...
<Card title="x402 支払いガイド" icon="credit-card" href="/jp/docs/platform/billing-payments/x402-payments">
...
<CardGroup cols={3}>
  <Card title="FAQ" icon="circle-question" href="/jp/docs/reference/faq">
    よくある質問
  </Card>
