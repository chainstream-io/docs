...
<CardGroup cols={2}>
  <Card title="認証" icon="key" href="/jp/docs/platform/authentication/api-keys-oauth">
    認証と認証情報の管理
  </Card>
  <Card title="データプライバシー" icon="shield" href="/jp/docs/platform/security/data-privacy">
    データプライバシーポリシー
  </Card>
  <Card title="エラーコード" icon="circle-exclamation" href="/jp/docs/reference/error-codes">
    完全なエラーコード一覧
  </Card>
  <Card title="Webhookの基礎" icon="webhook" href="/jp/docs/recipes/webhook-fundamentals">
    Webhookの設定と使用方法
  </Card>
</CardGroup>
