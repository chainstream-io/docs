...
**Schema 저장소**: [github.com/chainstream-io/streaming_protobuf/tron](https://github.com/chainstream-io/streaming_protobuf/tree/main/tron)
...
`TradeEvents`는 DEX 거래 데이터를 제공합니다 (Topic: `tron.dex.trades`). 공통 TradeEvent 구조를 사용합니다.
...
`BlockMessage`에는 Witness의 주소, ID, 서명이 포함됩니다.
...
<CardGroup cols={2}>
  ...
  <Card title="Solana Streams" icon="bolt" href="/ko/docs/access-methods/kafka-streams/solana-streams">
    Solana 고처리량 데이터 스트림
  </Card>
