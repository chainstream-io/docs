...
<CardGroup cols={2}>
  <Card title="컴플라이언스 통합 가이드" icon="plug" href="/ko/docs/compliance/integration-guide">
    KYA 통합 시작하기
  </Card>
  <Card title="KYT 핵심 개념" icon="magnifying-glass-dollar" href="/ko/docs/compliance/kyt-concepts">
    거래 수준 리스크 관리 알아보기
  </Card>
  <Card title="API 인증" icon="key" href="/ko/docs/platform/authentication/api-keys-oauth">
    인증 방법 이해하기
  </Card>
  <Card title="KYA API 레퍼런스" icon="code" href="/ko/api-reference/endpoint/data/kyt/v2/kyt-address-post">
    API 문서 보기
  </Card>
</CardGroup>
