...
Sign-In with X (SIWX)는 모든 API 요청에서 지갑으로 메시지에 서명하여 ChainStream에 인증할 수 있게 합니다 — API Key나 OAuth 토큰이 필요 없습니다. [x402 결제](/ko/guides/getting-started/x402-payments)를 통해 구독을 구매한 **온체인 지갑을 가진 AI 에이전트**를 위해 설계되었습니다.
...
자세한 내용은 [x402 결제](/ko/guides/getting-started/x402-payments)를 참고하세요.
