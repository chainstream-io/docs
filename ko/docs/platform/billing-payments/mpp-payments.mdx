...
<CardGroup cols={2}>
  <Card title="x402 결제 프로토콜" icon="money-bill-wave" href="/ko/docs/platform/billing-payments/x402-payments">
    x402 프로토콜을 통한 온체인 USDC 결제
  </Card>
  <Card title="빌링과 Unit" icon="receipt" href="/ko/docs/platform/billing-payments/plans-and-units">
    CU 소비량 및 플랜 상세 이해하기
  </Card>
</CardGroup>
