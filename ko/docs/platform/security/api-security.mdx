...
<CardGroup cols={2}>
  <Card title="인증" icon="key" href="/ko/guides/getting-started/authentication">
    인증 및 인증 정보 관리
  </Card>
  <Card title="데이터 프라이버시" icon="shield" href="/ko/guides/data-concepts/data-privacy">
    데이터 프라이버시 정책
  </Card>
  <Card title="오류 코드" icon="circle-exclamation" href="/ko/guides/resources/error-codes">
    전체 오류 코드 목록
  </Card>
  <Card title="Webhook 기본 개념" icon="webhook" href="/ko/playbooks/frameworks/webhook-fundamentals">
    Webhook 구성 및 사용법
  </Card>
</CardGroup>
