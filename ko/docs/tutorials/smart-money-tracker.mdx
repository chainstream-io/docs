...
시작하기 전에 [스마트 머니 분석 방법론](/ko/docs/data-products/smart-money)을 읽어 다음을 이해하는 것을 권장합니다:
...
<CardGroup cols={2}>
  ...
  <Card title="Webhook 기본 사항" icon="webhook" href="/ko/docs/recipes/webhook-fundamentals">
