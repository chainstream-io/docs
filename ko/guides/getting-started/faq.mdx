...
<AccordionGroup>
  <Accordion title="Access Token은 어떻게 발급하나요?">
    ...
    자세한 내용은 [인증 문서](/ko/guides/getting-started/authentication)를 참조하세요.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="지원하는 블록체인은 무엇인가요?">
    ...
    자세한 내용은 [실시간 스트리밍](/ko/guides/data-concepts/realtime-streaming)을 참조하세요.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="429 또는 403 오류가 발생하면 어떻게 하나요?">
    ...
    **문제 해결:**
    ...
    1. **429 - 속도 제한 확인**
       - 무료 플랜: 10 요청/분
       - 유료 플랜: [API 보안](/ko/guides/data-concepts/api-security) 참조
...
```
    ...
    일반적인 오류 코드는 [오류 코드](/ko/guides/resources/error-codes)를 참조하세요.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="KYT와 KYA의 차이점은 무엇인가요?">
    ...
    자세한 내용은 [보안 컴플라이언스 문서](/ko/guides/security-compliance/overview)를 참조하세요.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="MCP란 무엇인가요?">
    ...
    자세한 내용은 [MCP Server 문서](/ko/guides/ai-infrastructure/mcp-server/introduction)를 참조하세요.
  </Accordion>
  ...
  <Accordion title="Claude Desktop에서 ChainStream을 사용하려면?">
    ...
    자세한 설정은 [Claude Integration 가이드](/ko/guides/ai-infrastructure/mcp-server/setup-guide)를 참조하세요.
  </Accordion>
