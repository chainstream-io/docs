...
<CardGroup cols={2}>
  <Card title="REST——資料" icon="database" href="/zh-Hant/api-reference/endpoint/data/tokens/search">
    所有資料端點：tokens、trades、wallets、pools、smart money、search。
    由 OpenAPI 自動生成，每種語言都帶請求/響應示例。
  </Card>
  <Card title="REST——DeFi" icon="right-left" href="/zh-Hant/api-reference/endpoint/defi/quote">
