...
<CardGroup cols={2}>
  ...
  <Card title="EVM Streams" icon="ethereum" href="/zh-Hant/docs/access-methods/kafka-streams/evm-streams">
    EVM 鏈資料流
  </Card>
  <Card title="Solana Streams" icon="bolt" href="/zh-Hant/docs/access-methods/kafka-streams/solana-streams">
    Solana 高吞吐資料流
  </Card>
