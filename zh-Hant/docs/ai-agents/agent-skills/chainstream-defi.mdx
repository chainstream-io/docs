...
description: '不可逆 DeFi 執行 — 兌換、Launchpad、交易廣播'
icon: "right-left"
---
...
`chainstream-defi` skill 處理 Solana、BSC 和 Ethereum 上的鏈上 DeFi 執行，涵蓋 DEX 代幣兌換、Launchpad 發幣和已簽名交易廣播。
...
sequenceDiagram
  ...
  Agent->>User: "兌換 1 SOL 約得 X 代幣。手續費：Y。確認？"
  User-->>Agent: "確認"
...
| 402 需要付款 | CLI 透過 [x402 支付](/zh-Hant/docs/platform/billing-payments/x402-payments) 自動處理 |
