...
詳見[安裝指南](/zh-Hant/guides/ai-infrastructure/agent-skills/installation)。

## 下一步

<CardGroup cols={2}>
  <Card title="安裝" icon="download" href="/zh-Hant/guides/ai-infrastructure/agent-skills/installation">
    在你的平臺上配置 Skills
  </Card>
  ...
  <Card title="MCP Server" icon="plug" href="/zh-Hant/guides/ai-infrastructure/mcp-server/introduction">
    底層 MCP 協議
  </Card>
</CardGroup>
