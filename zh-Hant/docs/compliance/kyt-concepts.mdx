...
<CardGroup cols={2}>
  <Card title="KYA 核心概念" icon="user-shield" href="/zh-Hant/guides/data-concepts/kya-concepts">
    瞭解地址維度風控
  </Card>
  <Card title="合規整合指南" icon="plug" href="/zh-Hant/guides/data-concepts/compliance-integration">
    開始接入 KYT
  </Card>
  <Card title="API 認證" icon="key" href="/zh-Hant/guides/getting-started/authentication">
    瞭解認證方式
  </Card>
