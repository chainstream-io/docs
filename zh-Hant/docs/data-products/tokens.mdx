...
<CardGroup cols={2}>
  <Card title="REST——查詢與搜尋" icon="database" href="/zh-Hant/api-reference/endpoint/data/tokens/search">
  ...
  <Card title="WebSocket" icon="bolt" href="/zh-Hant/api-reference/endpoint/websocket/connection">
    訂閱 `tokens.price`、`tokens.created` 頻道。
  </Card>
...
REST / GraphQL 每次呼叫 **1 個 read unit**；安全與完整後設資料端點可能更貴。WebSocket 與 Kafka 按投遞條數計費。見 [計費與 unit](/zh-Hant/docs/platform/billing-payments/billing-and-units)。
