...
<CardGroup cols={2}>
  <Card title="ClawHub Skill" icon="puzzle-piece" href="/zh-Hant/guides/integrations/openclaw/skills-install">
    從 ClawHub 安裝 ChainStream Skill，或透過跨 Agent 的 Vercel Skills CLI 安裝。最快的設定方式——不到一分鐘即可完成。
  </Card>
  <Card title="直接 MCP 配置" icon="server" href="/zh-Hant/guides/integrations/openclaw/skills-install#方式三直接-mcp-配置">
...
<CardGroup cols={2}>
  <Card title="安裝方式" icon="download" href="/zh-Hant/guides/integrations/openclaw/skills-install">
