...
<CardGroup cols={2}>
  <Card title="認證" icon="key" href="/zh-Hant/guides/getting-started/authentication">
    認證與憑據管理
  </Card>
  <Card title="資料隱私" icon="shield" href="/zh-Hant/guides/data-concepts/data-privacy">
    資料隱私政策
  </Card>
  <Card title="錯誤碼" icon="circle-exclamation" href="/zh-Hant/guides/resources/error-codes">
    完整錯誤碼列表
  </Card>
