...
完整工具說明見 [MCP 工具目錄](/zh-Hant/docs/ai-agents/mcp-server/tools)。
  </Tab>
</Tabs>
...
<AccordionGroup>
  ...
  <Accordion title="能否實時跟蹤 Pump.fun 代幣？">
    可以。使用 WebSocket 訂閱獲取實時價格與成交流。配置方式見 [實時流式傳輸](/zh-Hant/docs/access-methods/websocket)。
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="代幣分析框架" icon="magnifying-glass-chart" href="/zh-Hant/docs/recipes/token-analysis-framework">
    系統化的代幣評估方法。
  </Card>
  <Card title="MCP 工具目錄" icon="robot" href="/zh-Hant/docs/ai-agents/mcp-server/tools">
    50+ MCP 工具完整列表，便於接入 AI Agent。
  </Card>
  <Card title="Raydium 指南" icon="droplet" href="/zh-Hant/docs/recipes/raydium">
