...
<AccordionGroup>
  <Accordion title="支援哪些區塊鏈？">
    ...
    完整列表見 [即時資料概念](/zh-Hant/docs/access-methods/websocket)。
  </Accordion>
...
<AccordionGroup>
  <Accordion title="收到 429 或 403 錯誤怎麼辦？">
    ...
    **排查步驟：**
    ...
    1. **429 - 檢查是否超頻**
       - Free 方案：10 請求/分鐘
       - 付費方案：見 [API 安全](/zh-Hant/docs/platform/security/api-security)
...
<AccordionGroup>
  ...
  <Accordion title="如何在 Claude Desktop 中使用 ChainStream？">
    ...
    詳細設定步驟見 [Claude Integration 指南](/zh-Hant/docs/ai-agents/mcp-server/setup)。
  </Accordion>
