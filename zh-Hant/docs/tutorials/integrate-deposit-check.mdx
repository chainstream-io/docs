---
title: '整合充值風控'
description: '使用 KYT API 構建交易所充值風險檢測系統'
icon: 'shield-check'
---

## 專案概述

本教程構建一個充值風控系統，在使用者充值時自動評估資金來源風險。
...
<CardGroup cols={2}>
  <Card title="KYT 概念" icon="magnifying-glass-dollar" href="/zh-Hant/docs/compliance/kyt-concepts">
    瞭解 KYT 工作原理
  </Card>
