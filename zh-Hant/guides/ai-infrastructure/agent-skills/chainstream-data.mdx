...
| 402 / "Payment required" | 按照 [x402 支付流程](/zh-Hant/guides/cli/x402-payment) 操作 |
...
<CardGroup cols={2}>
  <Card title="chainstream-defi" icon="right-left" href="/zh-Hant/guides/ai-infrastructure/agent-skills/chainstream-defi">
    研究後執行交易
  </Card>
