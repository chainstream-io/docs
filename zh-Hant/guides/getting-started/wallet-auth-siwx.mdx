...
Sign-In with X (SIWX) 允許你在每個 API 請求中透過錢包簽名進行認證 — 無需 API Key 或 OAuth Token。這是為**擁有鏈上錢包並透過 [x402 支付](/zh-Hant/guides/getting-started/x402-payments) 購買了訂閱的 AI Agent** 設計的。
...
詳見 [x402 支付](/zh-Hant/guides/getting-started/x402-payments)。
