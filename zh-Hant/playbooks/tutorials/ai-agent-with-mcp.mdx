...
<Note>
詳細步驟請參考 [MCP 配置指南](/zh-Hant/guides/ai-infrastructure/mcp-server/setup-guide)。
</Note>
...
<CardGroup cols={2}>
  <Card title="MCP 配置指南" icon="gear" href="/zh-Hant/guides/ai-infrastructure/mcp-server/setup-guide">
    詳細配置步驟
  </Card>
