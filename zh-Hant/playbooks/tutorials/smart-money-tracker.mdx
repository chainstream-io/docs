...
在開始之前，建議先閱讀 [Smart Money 方法論](/zh-Hant/guides/data-concepts/smart-money-methodology)，瞭解：
...
<CardGroup cols={2}>
  ...
  <Card title="Webhook 基礎" icon="webhook" href="/zh-Hant/playbooks/frameworks/webhook-fundamentals">
